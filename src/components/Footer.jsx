...
export default function Footer() {
  return (
    <footer className="bg-[#4285F4] h-64 pb-6" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto w-10/12 px-6 pb-8 pt-16 sm:pt-16 lg:px-8 lg:pt-24">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img className="h-11" src={ILogo} alt="Company name" />
            <p className="text-l font-medium text-start  text-white">
      ...
      <p className="text-2xl font-medium text-white text-center mt-6">
